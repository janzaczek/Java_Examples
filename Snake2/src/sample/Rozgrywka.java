...
public class Rozgrywka {
    ...
    static final long task_Uptade = 100; // ustala mi predkosc wez - im nizsze tym szybciej snake sie porusza
    //  − This is the delay in milliseconds before task is to be executed.
    static final long task_Delay = 0;// - This is the time in milliseconds between successive task executions.
...
//                    snake.setHeadLocation(gridSize, gridSize);
    ...
    //metody timerTask oraz obiekt animationTimer inspirowany z stackoverflow
}
